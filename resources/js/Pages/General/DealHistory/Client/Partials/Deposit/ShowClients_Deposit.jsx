...
const ShowClients = ({ closeModal, transaction }) => {
    const { transaction_number, created_at, transaction_date, merchant, amount, fee, status, from_wallet, to_wallet, description, payment_method } = transaction;
    ...
    return (
        <div className="flex flex-col gap-[20px]">
            ...
            <div className='flex flex-col border-t-[1px] border-solid border-neutral-700 gap-[8px]'>
                <div className={`flex flex-col gap-[4px] pt-[12px] ${payment_method === 'auto' ? '' : ''}`}>
                    <div className='text-sm text-neutral-500 font-bold'>
                        DESCRIPTION
                    </div>
