...
import { UserProfileIcon, UploadIcon } from '@/Components/Icon/Icon';
...
const Profile = ({ userProfile }) => {
    ...
    return (
        <Authenticated header="Profile">
            <Head title="Profile" />
            <div className="flex justify-center bg-[#0b1120]">
                <div className="bg-[#161b2d] xl:p-[80px] lg:p-[80px] md:p-[80px] px-[20px] py-[40px] rounded-lg shadow-lg text-white w-full ">
